...
// const combinationOfTwoNumbersHandler = (num1, num2) => [].concat(...num1.map(letter1 => num2.map(letter2 => letter1 + letter2)))
// const combinationsHandler = (a, b, ...c) => b ? combinationsHandler(combinationOfTwoNumbersHandler(a, b), ...c) : a
...
app.post('/convert', (req, res) => {
    //////kneka
    t9converter.combinationsHandler(req.body.value)
